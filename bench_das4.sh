#!/bin/bash
sbatch --nodes=1 main.job /var/scratch/hpcl1905/mouse_gene.mtx
...
sbatch --nodes=1 main.job /var/scratch/hpcl1905/ldoor.mtx
...
sbatch --nodes=1 main.job /var/scratch/hpcl1905/nlpkkt240.mtx
